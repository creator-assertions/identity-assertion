...
====
The diagram that follows, with one _<<C2PA Manifest>>_ containing one identity assertion, is intended to illustrate the most basic example of the two trust signals available and how they interesect:
