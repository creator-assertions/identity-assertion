...
*Pre-draft 24 January 2024* · xref:_version_history[]
...
IMPORTANT: For purposes of the Community Specification License, the [line-through]#link:https://github.com/creator-assertions/identity-assertion/blob/main/scope.md[scope.md document]# at the root of this project’s GitHub repository is the governing document of this specification’s scope. _This document is not yet public, but will be shortly._
