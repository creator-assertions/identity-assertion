...
.. If so, was the _<<_named_actor,named actor’s>>_ credential revoked at the time the *<<_identity_assertion,identity assertion>>* was signed? If so, the *<<_identity_assertion,identity assertion>>* SHOULD be treated as *revoked.*
...
.. If so, was the *<<_identity_assertion,identity assertion>> generator’s* credential revoked at the time the *<<_identity_assertion,identity assertion>>* was signed? If so, do not proceed. The *<<_identity_assertion,identity assertion>>* SHOULD be treated as *revoked.*
