...
*Version 1.0 Draft 17 June 2024* · xref:_version_history[]
...
A direct resolution of this threat may not be attainable. (Note that this is an as-yet unaddressed issue in the DNS ecosystem.) For that reason, identity assertion producers are encouraged to link multiple verifiable trust signals (social accounts, web sites, etc.) together to produce a stronger overall identity signal.
