...
The validator SHOULD verify that no entry in the `referenced_assertions` field is duplicated. The `cawg.identity.assertion.duplicate` error code SHALL be used to report violations of this rule.
