...
NOTE: TO DO: Read C2PA §8.1.7 for COSE signature validation rules.
...
Verify `issuanceDate` or `validFrom` relative to signing credential and C2PA manifest. (Must not be newer than manifest.)

Verify timestamp if present §8.1.7.
