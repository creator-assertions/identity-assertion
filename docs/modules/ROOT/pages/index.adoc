...
In some use cases, an _<<actor>>_ in the system may wish to provide its own https://www.w3.org/TR/vc-data-model/[W3C verifiable credential], as it exists at that moment in time, to the _claim generator_ to have it associated with one or more _<<_c2pa-assertion,C2PA assertions>>._ This actors may be an individual, group, or organization.
...
In some use cases, an _<<actor>_ in the system may wish to provide an https://tools.ietf.org/html/rfc5280[X.509 certificate] to have an organizational or individual identity described by the certificate associated with the _<<_c2pa-claim,C2PA claim>>._
