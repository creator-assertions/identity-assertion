...
NOTE: TO DO: Write new descriptive text about data flow diagram.
...
sequenceDiagram
  ...
  AT ->> W: Presentation request<br/>including description of asset
  create actor Alice
  W ->> Alice: Consent for signature
  destroy Alice
  Alice ->> W: Approved<br/>(including what to disclose)
  destroy W
