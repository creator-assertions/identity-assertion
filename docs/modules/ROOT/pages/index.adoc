...
Version 1.1 (adding identity claims aggregation) *Draft 04 December 2024* · xref:_version_history[]
...
| `cawg.uri_meta_tag_verification` | The _<<_identity_provider,identity provider>>_ verified control over a specific URI by providing unique content to be placed in an HTML `<meta>` tag. | link:https://support.google.com/webmasters/answer/9008080?visit_id=638690062950474628-2219554616&rd=1#meta_tag_verification&zippy=%2Chtml-tag[Verification method details: HTML tag (Google Support)]
| `cawg.oauth2` | The _<<_identity_provider,identity provider>>_ verified control over a specific account or resource using link:https://datatracker.ietf.org/doc/html/rfc6749[OAuth2]. |
|=======================
