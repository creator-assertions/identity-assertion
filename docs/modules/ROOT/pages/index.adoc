...
Version 1.x (adding W3C VC credentials) *Pre-Draft 25 March 2024* · xref:_version_history[]
...
The `sig_type` value for such an assertion MUST be `org.w3.verifiable_credential`.
