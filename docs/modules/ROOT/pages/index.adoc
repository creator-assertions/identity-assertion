...
Key discovery: https://www.w3.org/TR/vc-jose-cose/#key-discovery.

W3C VC verification: https://www.w3.org/TR/vc-data-model-2.0/#verification (§7.1). Also figure out how to reconcile W3C "problem details" (§7.2) with C2PA validation status.

Include DID verification as per DID method spec.

COSE signature verification as per C2PA §8.1.7.
