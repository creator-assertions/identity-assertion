...
A direct resolution of this threat may not be attainable. For that reason, identity assertion producers are encouraged to link multiple verifiable trust signals (social accounts, web sites, etc.) together to produce a stronger overall identity signal.
