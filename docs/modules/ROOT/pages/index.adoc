...
Primary value in protection against imitators or actors who would like to devalue the brand.

Look at Publicis "dream campaign of the future."
...
==== Digital creator and attribution

Content published by artist goes viral and gets moved across media sites.

My lodging next right, state prison picture.

==== Audio sampling and reuse

Get credit for audio sampling.
