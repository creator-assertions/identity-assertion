...
If the credential contains a `credentialStatus` entry, the validator SHALL inspect the contents of that entry as follows:



INITIAL DRAFT WORDING ENDS HERE -- TO-DO LIST / OUTLINE CONTINUES

NOTE: TO DO: Read through and incorporate/reference the following as appropriate.


Check credential status (revocation) §8.1.2.7.
...
NOTE: TO DO: Work in this section
