...
* In the case of document verification, the date and time at which the _<<_named_actor,named actor’s>>_ identity was verified by the document verification service.
