...
====
This section assumes that the following pending pull requests will be merged:
...
TO DO: Specify requirements for IA VC.

* Needs to have proof tying back to CH VC. (Is https://www.w3.org/TR/vc-data-integrity/ relevant?)

==== Example of identity assertion verifiable credential

TO DO: Create example of IA VC.
