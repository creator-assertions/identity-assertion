...
| `cawg.federated_login` | The _<<_identity_provider,identity provider>>_ verified control over a specific account or resource using a federated log-in protocol such as link:https://datatracker.ietf.org/doc/html/rfc6749[OAuth2]. |
|=======================
