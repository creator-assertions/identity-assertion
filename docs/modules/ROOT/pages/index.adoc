...
*Preliminary draft 18 December 2023* +
...
Once the verifiable presentation has been obtained, the identity assertion can be formed. The `sig_type` value for such an assertion MUST be `org.w3.verifiable_presentation` and the `signature` value MUST be the _verifiable presentation_ serialized as described in link:++https://www.w3.org/TR/vc-data-model/#json-ld++[Section 6.2, “JSON-LD,”] of the W3C verifiable credentials data model spec. Further requirements for the _verifiable presentation_ are described in xref:_verifiable_presentation_requirements[xrefstyle=full].
...
The _DID document_ for the _<<_c2pa_actor,C2PA actor,>>_ which is located by resolving the _https://www.w3.org/TR/did-core/[W3C decentralized identifier]_ from the _https://www.w3.org/TR/vc-data-model/[W3C verifiable credential],_ and MUST confirm to the requirements stated in link:++https://www.w3.org/TR/did-core/#representations++[Section 6, “Representations,”] of the W3C decentralized identifier specification.

In addition, the _DID document_ MUST contain an `assertionMethod` field as defined by link:++https://www.w3.org/TR/did-core/#assertion__[Section 5.3.2, “Assertion,”] of the W3C decentralized identifiers specification.

An example of a compliant DID document, which is non-normative, is shown below:
...
When using a _W3C verifiable credential_ to represent the credential subject, the `signature` value of the identity assertion MUST be the _verifiable presentation_ serialized as described in link:++https://www.w3.org/TR/vc-data-model/#json-ld++[Section 6.2, “JSON-LD,”] of the W3C verifiable credentials data model spec and also comply with the constraints described in this section.

The `@context` property MUST contain the following URIs in the following sequence:

* https://www.w3.org/2018/credentials/v1
* (TBD: CAI identity spec URL context)

The `type` property MUST contain the following type names:

* `"VerifiablePresentation"`
* `"ContentAuthenticityIdentityPresentation"`


An example of a compliant verifiable presentation, which is non-normative, is shown below:
