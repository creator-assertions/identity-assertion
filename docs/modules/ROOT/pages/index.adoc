...
* `pad1` and `pad2` are zero-value (`0x00`) byte strings used to fill space
...
identity = {
  ...
  "pad1": bstr, ; zero-value (`0x00`) byte string used for filling up space
  ? "pad2": bstr, ; optional zero-value (`0x00`) byte string used for filling up space
}
----
