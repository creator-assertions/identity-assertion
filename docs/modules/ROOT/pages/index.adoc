...
Version 1.x (adding W3C VC credentials) *Draft 02 August 2024* · xref:_version_history[]
...
[NOTE]
====
TO DO (link:https://github.com/creator-assertions/identity-assertion/issues/161[Issue #161]): Provide definitions for _identity assertion_ and _identity assertion provider._

These terms are used throughout this section and should be added to the glossary. Preliminary definitions:

* _identity assertion generator:_ akin to the claim generator: what's the software that's producing the identity assertion itself
