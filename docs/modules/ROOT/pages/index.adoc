...
* Do I trust that the identifiers for the credential *issuer* is unique?
...
*Human trust* exists if the following requirements are satisfied:
...
While _human trust_ requires _technical trust_ to be established in order to evaluate it meaningfully, these criteria are largely subjective and thus outside the scope of this specification.
