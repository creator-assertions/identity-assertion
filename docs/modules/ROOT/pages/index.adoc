...
NOTE: TO DO: Include description of how referencing happens before we start talking about reference (next paragraph).

The `assertions` entry of each identity assertion MUST NOT reference the same identity assertion itself.
