...
IMPORTANT: The identity assertion should not be construed to convey _ownership_ of a _<<C2PA asset>>._ Ownership and rights transfers are often conducted outside of the digital realm. There should be no expectation that such transactions could be accurately reflected and updated in this assertion.
