...
==== Tampering with identity assertion

NOTE: TO DO: Write new section describing potential attacks on the content of the identity assertion itself. Signature within IA should protect against `signer_payload` modifications and C2PA hash-link references should protect against substitution of a new identity assertion.
