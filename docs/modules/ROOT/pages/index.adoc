...
*Pre-draft 19 January 2024* +
Copyright © 2024, (organization to be named) +
...
NOTE: TO DO: Write a scope document, which is required for CSL. This may replace the following "Design goals" section.
