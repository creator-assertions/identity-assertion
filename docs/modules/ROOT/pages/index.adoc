...
The indirect trust relationship is often managed via one or more _trust lists_ or _intermediate certificate authorities,_ which evaluate the credential-issuing practices of _issuers_ and add or remove issuers in accordance with well-stated governance principles.
