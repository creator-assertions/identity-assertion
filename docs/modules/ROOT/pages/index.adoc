...
*Version 1.0 Draft 09 June 2024* · xref:_version_history[]
...
* *Technical trust:* Can I prove that the content I’m consuming came from a particular _<<_named_actor,named actor>>_ and that it hasn’t been tampered with?
