...
IMPORTANT: Future minor version updates (1.1, 1.2, etc.) to this specification MAY add new sections to this specification defining new credential types and their corresponding `sig_type` values. Such updates to the specification SHOULD continue to use the `cawg.identity` assertion label.
