...
Implementors are encouraged to apply one or more of the following approaches to mitigate this potential attack:
...
To some extent, this concern is addressed by (same concept as C2PA) evaluating identity assertion signatures as trusted, well-formed, or invalid.
